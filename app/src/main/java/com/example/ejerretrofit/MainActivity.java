...
public class MainActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Call<CursorJoiner.Result> listCall = retrofitService.getData();
    ...
    private List<java.lang.Character> getCharacters(List<java.lang.Character> list, int elements) {

        List<java.lang.Character> newList = new ArrayList<>();
